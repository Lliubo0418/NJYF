...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOD, EN_R4_Pin|A0_R2_R4_Pin|A1_R2_R4_Pin|A2_R2_R4_Pin
                          |A3_R2_R4_Pin|ACTION1_Pin|ACTION_Pin|RELAY_CTRL_Pin
                          |EN_R1_Pin|A0_R1_R3_Pin|A1_R1_R3_Pin|A2_R1_R3_Pin
                          |A3_R1_R3_Pin, GPIO_PIN_SET);
  ...
  GPIO_InitStruct.Pin = EN_R4_Pin|A0_R2_R4_Pin|A1_R2_R4_Pin|A2_R2_R4_Pin
                          |A3_R2_R4_Pin|ACTION1_Pin|ACTION_Pin|RELAY_CTRL_Pin
                          |EN_R3_Pin|EN_R1_Pin|A0_R1_R3_Pin|A1_R1_R3_Pin
                          |A2_R1_R3_Pin|A3_R1_R3_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_OD;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
...
void R1_R3_Channel_Sel(uint8_t ch) { // MPC1通道切换
...
void R2_R4_Channel_Sel(uint8_t ch) { // MPC2通道切换
    // 取低四位，ch % 16 可以简化为 ch & 0x0F
    ch &= 0x0F;
