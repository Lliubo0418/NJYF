...
//bit   idata   find_key;                   //功能按键按下
//
//
////----------------------------UART1-----------------------------------------
//uchar data receive1[12]={' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' '};
//uchar data send_buf[12]={' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' '};
//
...
//{
//  send_buf[0]='#';                      // 在send_buf数组的第一个位置放入字符 '#'
//    send_buf[1]=par_buf[20]+0x41;       // 根据par_buf数组中的某个元素，计算出要发送的第二个字节
//  send_buf[10]=0x0d;                    // 设置数据包的倒数第二个字节为 0x0d（回车符）
//    //send_buf[10]=send_buf[1]^send_buf[2]^send_buf[3]^send_buf[4]^send_buf[5]^send_buf[6]^send_buf[7]^send_buf[8]^send_buf[9];
//  send_buf[11]=0x0a;                    // 设置数据包的最后一个字节为 0x0a（换行符）
...
//
//  txcount0=11;
//  txptr0=1;//从第1个字节开始发送     //此处是否需要修改，数据不对，再做修改
...
//  else if(err_flag==1)
//    {
//      send_buf[4]=receive0_temp[0];
//      send_buf[5]= receive0_temp[1];
//      send_buf[6]=receive0_temp[2];
//      send_buf[7]=' ';
//      send_buf[8]=' ';
//      send_buf[9]=' ';
//
...
//  else if(err_flag==1)
//    {
//      send_buf[0]=receive0_temp[0];
//      send_buf[1]= receive0_temp[1];
//      send_buf[2]=receive0_temp[2];
//      send_buf[3]=' ';
//      send_buf[4]=' ';
//      send_buf[5]=' ';
//
...
//      send_buf[2]= 'R';
//      send_buf[3]= 'B';
//      send_buf[4]=par_buf[0]+0x30;
//      send_buf[5]=par_buf[1]+0x30;
//      send_buf[6]='.';
//      send_buf[7]=par_buf[2]+0x30;
//      send_buf[8]=par_buf[3]+0x30;
//      send_buf[9]=par_buf[4]+0x30;
//
//      send_crc_buf();
//
//}
...
//      send_buf[2]= 'R';
//      send_buf[3]= 'E';
//      send_buf[4]=par_buf[5]+0x30;
//      send_buf[5]=par_buf[6]+0x30;
//      send_buf[6]='.';
//      send_buf[7]=par_buf[7]+0x30;
//      send_buf[8]=par_buf[8]+0x30;
//      send_buf[9]=par_buf[9]+0x30;
//
//      send_crc_buf();
//
//}
...
//      send_buf[2]= 'D';
//      send_buf[3]= 'L';
//      send_buf[4]=par_buf[15]+0x30;
//      send_buf[5]=par_buf[16]+0x30;
//      send_buf[6]='.';
//      send_buf[7]=par_buf[17]+0x30;
//      send_buf[8]=par_buf[18]+0x30;
//      send_buf[9]=par_buf[19]+0x30;
//
//        send_crc_buf();
//
//}
...
//      send_buf[2]= 'D';
//      send_buf[3]= 'H';
//      send_buf[4]=par_buf[10]+0x30;
//      send_buf[5]=par_buf[11]+0x30;
//      send_buf[6]='.';
//      send_buf[7]=par_buf[12]+0x30;
//      send_buf[8]=par_buf[13]+0x30;
//      send_buf[9]=par_buf[14]+0x30;
//        send_crc_buf();
//
//}
//
...
//      send_buf[2]= 'A';
//      send_buf[3]= 'H';
//      send_buf[4]=par_buf[21]+0x30;
//      send_buf[5]=par_buf[22]+0x30;
//      send_buf[6]='.';
//      send_buf[7]=par_buf[23]+0x30;
//      send_buf[8]=par_buf[24]+0x30;
//      send_buf[9]=par_buf[25]+0x30;
//        send_crc_buf();
//}
//
//
...
//      send_buf[3]= 'e';
//      send_buf[4]='r';
//      send_buf[5]=version_major;
//      send_buf[6]='.';
//      send_buf[7]=version_minor;
//      send_buf[8]='0';
//      send_buf[9]='0';
//      send_crc_buf();
//
...

{
  ...
  {tl0timer0++;}//与PC通信空闲的时间*/
   ...
   key_value_temp=(~P1)&0xf0; // 0x00101110  P1^4:SET; P1^5:ADD; P1^6:REDUCE; P1^7:OK
