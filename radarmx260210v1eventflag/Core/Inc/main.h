...
#define FPGA_CTRL_READ_EXTI_IRQn EXTI9_5_IRQn
...
#define FPGA_SIDE_CTRL_Pin GPIO_PIN_3
#define FPGA_SIDE_CTRL_GPIO_Port GPIOD
#define FPGA_SIDE_CTRL_EXTI_IRQn EXTI3_IRQn
...
#define FPGA_SIDE_FLAG                  HAL_GPIO_ReadPin(FPGA_CTRL_SIDE_GPIO_Port, FPGA_CTRL_SIDE_Pin)     /* ��ȡFPGA_CTRL_SIDE_PIN���� */
...
extern uint8_t tigger_error_flag;
extern uint8_t ws_ds_flag;
extern uint32_t peak_pos;
extern volatile uint16_t peak_pos_l, peak_pos_h;
