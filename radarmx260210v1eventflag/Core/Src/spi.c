...
uint8_t spi2_write_gain(void)
{
    uint8_t rxdata;
    
    SPI2_CS_SIN(0);
    HAL_SPI_TransmitReceive(&hspi2,&par_params.sin_gain , &rxdata, 1, 1000);
    SPI2_CS_SIN(1);
   
		HAL_Delay(1);

    SPI2_CS_COS(0);
    HAL_SPI_TransmitReceive(&hspi2, &par_params.cos_gain, &rxdata, 1, 1000);
    SPI2_CS_COS(1);
