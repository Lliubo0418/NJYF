...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, JCOUT_Pin|JCOUT1_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(EN_R2_GPIO_Port, EN_R2_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, EN_R4_Pin|A0_R3_R4_Pin|A1_R3_R4_Pin|A2_R3_R4_Pin
                          |A3_R3_R4_Pin|EN_R3_Pin|EN_R1_Pin|A0_R1_R2_Pin
                          |A1_R1_R2_Pin|A2_R1_R2_Pin|A3_R1_R2_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pins : PDPin PDPin PDPin PDPin
                           ...
                           PDPin PDPin PDPin */
  GPIO_InitStruct.Pin = EN_R4_Pin|A0_R3_R4_Pin|A1_R3_R4_Pin|A2_R3_R4_Pin
                          |A3_R3_R4_Pin|EN_R3_Pin|EN_R1_Pin|A0_R1_R2_Pin
                          |A1_R1_R2_Pin|A2_R1_R2_Pin|A3_R1_R2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_OD;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
