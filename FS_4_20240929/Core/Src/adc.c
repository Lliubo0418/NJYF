...
#define VOLTAGE_LOWER_LIMIT  0.8
#define VOLTAGE_UPPER_LIMIT  1.2
...
void HAL_ADC_MspInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC1_MspInit 0 */
    ...
    PB1     ------> ADC1_IN9
    */
    GPIO_InitStruct.Pin = SP9_Pin|SP1_Pin|SP2_Pin|SP3_Pin
                          |SP4_Pin|SP5_Pin|SP6_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = SP7_Pin|SP8_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PB1     ------> ADC1_IN9
    */
    HAL_GPIO_DeInit(GPIOA, SP9_Pin|SP1_Pin|SP2_Pin|SP3_Pin
                          |SP4_Pin|SP5_Pin|SP6_Pin);

    HAL_GPIO_DeInit(GPIOB, SP7_Pin|SP8_Pin);
...
void Read_ADC_Values()
{
  ...
  for (int i = 0; i < NUM_CHANNELS; i++)
  {
    ...
    if (sp[i] > VOLTAGE_UPPER_LIMIT || sp[i] < VOLTAGE_LOWER_LIMIT)
    {
      error_flag |= (1 << i);
    }
    else
